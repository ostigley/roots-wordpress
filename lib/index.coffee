...
(function() {
  var API, RootsUtil, W, add_posts_to_locals, add_urls_to_posts, path, render_single_views, request, _, create_tag_tree,render_tag_views, results_obj;
  ...
  render_tag_views = function(config, tag_tree, obj) {
